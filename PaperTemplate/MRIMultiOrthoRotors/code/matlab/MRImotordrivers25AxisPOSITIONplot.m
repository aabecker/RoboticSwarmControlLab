function MRImotordrivers25AxisPOSITIONplot()
    % plots 25 rotors being controlled simultaneously by MRI gradient field
    ...
    [T,Y] = ode45(@MRImultipleRotors,(0:0.05:30),state0,options);
    ...
    print -dpdf '../../pictures/pdf/PositionConverge25controlload.pdf'
